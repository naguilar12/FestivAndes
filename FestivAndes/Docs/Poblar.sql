...
INSERT INTO FESTIVAL (ID,NAME,ANIO,PAIS,FECHAINICIO,FECHAFIN) VALUES(1,'FestivAndes',2017,'Colombia','07-05-2017','07-11-2017');
...
insert into SITIO (ID, NOMBRE_SITIO, DIRECCION, CAPACIDAD, LUGAR_ABIERTO, APTO_INCAPACITADOS, INICIO_HORARIO, FIN_HORARIO, PROTECCION_LLUVIA, EFECTOS_ATMOSFERICOS) values (1, 'Teatro Español','208 Pepper Wood', 34, 0, 1, '03-JUN-15 12.00.00', '20-ENE-17 11.11.08', 0, 0);
...
insert into SITIO (ID, NOMBRE_SITIO, DIRECCION, CAPACIDAD, LUGAR_ABIERTO, APTO_INCAPACITADOS, INICIO_HORARIO, FIN_HORARIO, PROTECCION_LLUVIA, EFECTOS_ATMOSFERICOS) values (6, 'Teatro de los sueños', '03 Linden Lane', 90, 1, 1, '25-ABR-99 12.00.00', '19-DIC-06 12.00.00', 1, 0);
